!function(a){
    ...
    // a("#carousel").owlCarousel({navigation:!1,slideSpeed:300,paginationSpeed:400,responsiveRefreshRate:200,responsiveBaseWidth:window,pagination:!0,autoPlay:!0,singleItem:!0});
    ...
    a(d).on("click",function(){
        ...
        e.slideToggle(),
        a(".main-nav li a").addClass("mobile"),!1
    }),
    a(window).on("resize",function(){
        var b=a(window).width();
        b>320&&e.is(":hidden")&&(e.removeAttr("style"),
        a(".main-nav li a").removeClass("mobile"))
    }),
    a(".main-nav li a").on("click",function(){
        a(this).hasClass("mobile")&&(e.slideToggle(),
